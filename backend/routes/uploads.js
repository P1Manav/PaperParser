...
router.post("/upload", upload.single("file"), (req, res) => {
  ...
  switch (outputType) {
    case "PPT":
      pythonScript = path.join(__dirname, "../generate_ppt.py");
      break;
    case "Podcast":
      pythonScript = path.join(__dirname, "../generate_podcast.py");
      break;
    case "Graphical Abstract":
      pythonScript = path.join(__dirname, "../generate_graphical_abstract.py");
      break;
    case "Video":
      pythonScript = path.join(__dirname, "../generate_video.py");
      break;
    default:
